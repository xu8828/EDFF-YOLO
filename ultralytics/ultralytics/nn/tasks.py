...
from ultralytics.nn.modules.block import C2f_Star, HFFM, SBA, C2f_LEEB
from ultralytics.nn.modules.head import SDED
...
from ultralytics.nn.modules.conv import DeformConv2d
...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect, SDED)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            PSA,
            SCDown,
            C2fCIB, C2f_Star, C2f_LEEB,
            DeformConv2d,
        }:
            c1, c2 = ch[f], args[0]
            if m is DeformConv2d:
                args = [c1, c2, *args[1:]]  # 对应 inc, outc, kernel_size, stride
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB, C2f_Star, C2f_LEEB}:
        ...
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, v10Detect, SDED}:
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, v10Detect, SDED)):
                return "detect"
