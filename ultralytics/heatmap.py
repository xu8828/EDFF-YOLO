...
class yolov8_heatmap:
    ...
    def draw_detections(self, box, color, name, img):
        ...
        cv2.putText(img, str(name), (xmin, ymin - 5), cv2.FONT_HERSHEY_SIMPLEX, 1, tuple(int(x) for x in color), 2, lineType=cv2.LINE_AA)
        return img
...
def get_params():
    params = {
        'weight': '/home/xie/wns/paper/code/ultralytics-yolo11-20241112/ultralytics-yolo11-main/runs/train/exp32/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/home/xie/xcl/paper/code/yolov8/ultralytics/blur/005513.jpg', 'result19')
